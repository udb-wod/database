...
REM ##################################################################################################
SET CurrentVersion="001"
SET StableVersion="001"
CLS
ECHO =====================================================================
ECHO UDB-WoD INSTALLATION HELPER SCRIPT - SIMPLIFIED MANAGEMENT FOR USERS
...
ECHO ...........................................................................
ECHO.
ECHO 1 - UDB-WoD Full Database Install with Newest Data and Latest SD2 and ACID
ECHO 2 - UDB-WoD Full Database From Older Stable Release and Latest SD2 and ACID
ECHO 3 - COMPLETE 3 DATABASE RESET - DB WIPE
...
ECHO.
ECHO ----------------------------------------------------------------------------
ECHO (MAKE SURE YOUR CMaNGOS-WoD / SD2-WoD / ACID-WoD REPOS ARE UP TO DATE FIRST)
ECHO ----------------------------------------------------------------------------
...
CLS
ECHO ======================================================================
ECHO UDB-WoD Full Database Install with Newest Data and Latest SD2 and ACID
ECHO ======================================================================
ECHO.
ECHO .......................................
...
CLS
ECHO =======================================================================
ECHO UDB-WoD Full Database From Older Stable Release and Latest SD2 and ACID
ECHO =======================================================================
ECHO.
ECHO .......................................
ECHO Please Confirm Your Installation Option 
...
CLS
ECHO ===========================================================================
ECHO Database Reset (%MangosDB%/%CharactersDB%/%ScriptDev2DB%)
ECHO ===========================================================================
ECHO.
ECHO .......................................
ECHO Please Confirm Your Installation Option 
...
ECHO ------------------------------------------------------------
copy /a Current_Release\Full_DB\*.sql /b Temp_Created_Files\000_WOD_Full.sql
copy /a Updates\*.sql /b Temp_Created_Files\100_WOD_NewData.sql
...
copy /a %ACID%\acid_wod.sql /b Temp_Created_Files\103_ACID_WOD.sql
...
ECHO -----------------------------------------
mysql.exe --user=%User% --password=%Password% < Tools\Install_Script_Helpers\UDB_Drop_Mysql.sql
ECHO.
ECHO -------------------------------------------------
